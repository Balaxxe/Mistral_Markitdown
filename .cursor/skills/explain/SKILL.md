---
name: explain
description: Explain the selected code or current file, including purpose, control flow, dependencies, edge cases, and gotchas. Slash-invoked; does not modify files.
